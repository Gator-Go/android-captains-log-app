...
processFiles(new File("../captainsLog"), changes)

// ******** Include new files ********

// Copy logo
new File("./logo.png").withInputStream { src ->
    new File("../captainsLog/app/src/main/res/drawable/logo.png").withOutputStream { dst ->
        dst << src
    }
}
...
new File("./hdpi-logo.png").withInputStream { src ->
    new File("../captainsLog/app/src/main/res/drawable-hdpi/logo.png").withOutputStream { dst ->
        dst << src
    }
}
...
new File("./ldpi-logo.png").withInputStream { src ->
    new File("../captainsLog/app/src/main/res/drawable-ldpi/logo.png").withOutputStream { dst ->
        dst << src
    }
}
...
new File("./mdpi-logo.png").withInputStream { src ->
    new File("../captainsLog/app/src/main/res/drawable-mdpi/logo.png").withOutputStream { dst ->
        dst << src
    }
}
...
new File("./xhdpi-logo.png").withInputStream { src ->
    new File("../captainsLog/app/src/main/res/drawable-xhdpi/logo.png").withOutputStream { dst ->
        dst << src
    }
}
...
new File("./xxhdpi-logo.png").withInputStream { src ->
    new File("../captainsLog/app/src/main/res/drawable-xxhdpi/logo.png").withOutputStream { dst ->
        dst << src
    }
}
